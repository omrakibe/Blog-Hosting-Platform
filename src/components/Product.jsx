...
const Product = () => {
  ...
  const deleteProduct = async () => {
    try {
      await axios.delete(`https://blog-hosting-server.onrender.com/api/product/${id}`);
      removeFromCart(id);
      ...
      <div className="containers" style={{ display: "flex" }}>
        ...
        <div className="right-column" style={{ width: "50%" }}>
          <div className="product-description">
            ...
            <i style={{ marginBottom: "3rem" }}>Auhor: {product.author}</i>
            <br />
            <hr />
            <p style={{fontWeight:'bold',fontSize:'1rem',margin:'10px 0px 0px'}}><u>Content :</u></p>
            <p style={{ marginBottom: "1rem" }}>{product.content}</p>
          </div>
